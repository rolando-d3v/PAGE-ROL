  ...
  return (
    <div className="bg-gray-100 w-full">
      ...
      <section className="bg-white py-14 md:w-10/12 lg:w-9/12 xl:w-3/5 mx-auto">
        <div className="w-8/12 mx-auto md:flex md:space-x-8  md:items-center  ">
      ...
      <section>
        <div>
          <h3>AirPods</h3>
          <p>
            Los AirPods se conectan fácilmente y te siguen el ritmo todo el día.
          </p>
          <h3> Más información</h3>
        </div>
        <div>
          <img src="/web5/main4_2.png" alt="r" />
        </div>
      </section>
    </div>
  );
